...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var sumOne = sum(b, c);
  var productOne = multiply(b, c);
  var sumTotal = sum(sumOne[0], a);
...
function sumArray(testArray){ //eslint-disable-line
  ...
  arrayTotal = sumAndMultiply(testArray[0], testArray[1], testArray[2])[0];
  // console.log(arrayTotal);

  arrayMessage = testArray + ' was passed in as an array of numbers, and ' + arrayTotal + ' is their sum.';
